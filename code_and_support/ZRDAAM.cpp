//---------------------------------------------------------------------------
// RDAAM / ZrDAAM routine kindly provided by Rich Ketcham
// Modified slightly for use as ZRDAAM routine for Arvert 7 - mostly in header

// do list item: probably I should move trapRmr0 to be an input so that users can tweak
// apatite kinetics without recompiling. Probably best to be part of either crs.in or 
// mineral input, but then will have to pass this to function and so change parameter
// list here, in calls, and in function prototype(s).
